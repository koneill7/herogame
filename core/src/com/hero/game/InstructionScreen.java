...
public class InstructionScreen implements Screen {
    ...
    public static float SCREEN_HEIGHT = 730;
    private Hero game;
    ...
    InstructionScreen(Hero game, Preferences preferences){
        this.game = game;
        this.preferences = preferences;
    }
    @Override
    public void show() {
        heroTexture = new Texture("instructions.png");
        ...
        instButton.addListener(new ClickListener(){
            public void clicked(InputEvent input, float x, float y){
                ((Game)Gdx.app.getApplicationListener()).setScreen(new HeroScreen(game, preferences));
            }
        });
    }
